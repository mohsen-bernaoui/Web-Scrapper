...
getter=requests.get('https://h1bdata.info/index.php?em=&job=software+engineer&city=&year=2022').text
...
transposed_df.to_csv('your_transposed_file_data_software.csv', index=False)

transposed_df.to_excel('your_transposed_file_data_software.xlsx',index=False)
